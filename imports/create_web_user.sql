...
GRANT SELECT,INSERT,UPDATE ON lingwhaat.wikipedia_canonical_pattern TO '${MYSQL_WEB_USER}'@'%';
...
GRANT SELECT,INSERT,UPDATE ON lingwhaat.letter_frequency TO '${MYSQL_WEB_USER}'@'%';
...
GRANT SELECT,INSERT,UPDATE ON lingwhaat.pronunciation_pali_language TO '${MYSQL_WEB_USER}'@'%';
FLUSH PRIVILEGES;