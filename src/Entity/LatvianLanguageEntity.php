...
#[ORM\Table(
    name: "pronunciation_latvian_language",
    indexes: [
...
class LatvianLanguageEntity
{
    ...
    public function setTsCreated(string $tsCreated): LatvianLanguageEntity
    {
    ...
    public function setScore(int $score): LatvianLanguageEntity
    {
        $this->score = $score;
        return $this;
    }
