...
#[ORM\Entity(repositoryClass: SwedishLanguageRepository::class)]
#[ORM\Table(
    name: "pronunciation_swedish_language",
    indexes: [
        new ORM\Index(name: 'i_name', columns: ['name']),
    ]
)]
class SwedishLanguageEntity
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    public function setId(int $id): SwedishLanguageEntity
    {
        $this->id = $id;
        return $this;
    }
    ...
    public function setName(string $name): SwedishLanguageEntity
    {
        $this->name = $name;
        return $this;
    }
    ...
    public function setScore(int $score): SwedishLanguageEntity
    {
        $this->score = $score;
        return $this;
    }
