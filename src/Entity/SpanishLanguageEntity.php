...
#[ORM\Table(
    name: "pronunciation_spanish_language",
    indexes: [
...
class SpanishLanguageEntity
{
    ...
    public function setTsCreated(string $tsCreated): SpanishLanguageEntity
    {
    ...
    public function setScore(int $score): SpanishLanguageEntity
    {
        $this->score = $score;
        return $this;
    }
