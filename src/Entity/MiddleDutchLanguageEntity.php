...
#[ORM\Entity(repositoryClass: MiddleDutchLanguageRepository::class)]
#[ORM\Table(
    name: "pronunciation_middledutch_language",
    indexes: [
        new ORM\Index(name: 'i_name', columns: ['name']),
    ]
)]
class MiddleDutchLanguageEntity
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    public function setScore(int $score): MiddleDutchLanguageEntity
    {
        $this->score = $score;
        return $this;
    }
