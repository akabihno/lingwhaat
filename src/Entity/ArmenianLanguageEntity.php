...
#[ORM\Table(
    name: "pronunciation_armenian_language",
    indexes: [
...
class ArmenianLanguageEntity
{
    ...
    public function setTsCreated(string $tsCreated): ArmenianLanguageEntity
    {
    ...
    public function setScore(int $score): ArmenianLanguageEntity
    {
        $this->score = $score;
        return $this;
    }
