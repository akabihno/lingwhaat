...
#[ORM\Table(
    name: "pronunciation_english_language",
    indexes: [
...
class EnglishLanguageEntity
{
    ...
    public function setTsCreated(string $tsCreated): EnglishLanguageEntity
    {
    ...
    public function setScore(int $score): EnglishLanguageEntity
    {
        $this->score = $score;
        return $this;
    }
