...
class JapaneseLanguageEntity
{
    ...
    public function setId(int $id): JapaneseLanguageEntity
    {
        $this->id = $id;
        return $this;
    }
    ...
    public function setName(string $name): JapaneseLanguageEntity
    {
        $this->name = $name;
        return $this;
    }
    ...
    public function setIpa(string $ipa): JapaneseLanguageEntity
    {
        $this->ipa = $ipa;
        return $this;
    }
