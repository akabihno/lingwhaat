...
#[ORM\Table(
    name: "pronunciation_russian_language",
    indexes: [
...
class RussianLanguageEntity
{
    ...
    public function setTsCreated(string $tsCreated): RussianLanguageEntity
    {
    ...
    public function setScore(int $score): RussianLanguageEntity
    {
        $this->score = $score;
        return $this;
    }
