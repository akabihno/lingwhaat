...
#[ORM\Table(
    name: "pronunciation_german_language",
    indexes: [
...
class GermanLanguageEntity
{
    ...
    public function setTsCreated(string $tsCreated): GermanLanguageEntity
    {
    ...
    public function setScore(int $score): GermanLanguageEntity
    {
        $this->score = $score;
        return $this;
    }
