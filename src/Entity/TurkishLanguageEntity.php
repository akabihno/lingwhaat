...
#[ORM\Table(
    name: "pronunciation_turkish_language",
    indexes: [
...
class TurkishLanguageEntity
{
    ...
    public function setTsCreated(string $tsCreated): TurkishLanguageEntity
    {
    ...
    public function setScore(int $score): TurkishLanguageEntity
    {
        $this->score = $score;
        return $this;
    }
