...
class LanguageMappings
{
    ...
    public const string NORWEGIAN_LANGUAGE_NAME = 'Norwegian';
    ...
    public static function getEntityClassByLanguageCode(string $languageCode): ?string
    {
        $map = [
            self::AFAR_LANGUAGE_CODE => 'App\Entity\AfarLanguageEntity',
            self::AFRIKAANS_LANGUAGE_CODE => 'App\Entity\AfrikaansLanguageEntity',
            ...
            self::GALICIAN_LANGUAGE_CODE => 'App\Entity\GalicianLanguageEntity',
            self::GEORGIAN_LANGUAGE_CODE => 'App\Entity\GeorgianLanguageEntity',
            self::GERMAN_LANGUAGE_CODE => 'App\Entity\GermanLanguageEntity',
            self::GREEK_LANGUAGE_CODE => 'App\Entity\GreekLanguageEntity',
            self::GULLAH_LANGUAGE_CODE => 'App\Entity\GullahLanguageEntity',
            self::HAUSA_LANGUAGE_CODE => 'App\Entity\HausaLanguageEntity',
            self::HEBREW_LANGUAGE_CODE => 'App\Entity\HebrewLanguageEntity',
    ...
    {
        $map = [
            self::AFAR_LANGUAGE_NAME => self::AFAR_LANGUAGE_CODE,
            ...
            self::GEORGIAN_LANGUAGE_NAME => self::GEORGIAN_LANGUAGE_CODE,
            self::GERMAN_LANGUAGE_NAME => self::GERMAN_LANGUAGE_CODE,
            self::GREEK_LANGUAGE_NAME => self::GREEK_LANGUAGE_CODE,
